...
const PropertyCard = () => {
  ...
  return (
    <div className="flex items-center justify-center h-full">
      {/* the div from the top is only use from styling and to be remove once finish */}

      <div className="w-11/12 overflow-hidden bg-gray-300 rounded-lg shadow-xl md: 1/2 lg:w-1/3">
          ...
          <div className="pb-2">
            <div className="flex justify-between py-2">
              <div className="flex items-center text-yellow-600">
                ...
                <p className="text-black">{property.location.address}</p>
              </div>
