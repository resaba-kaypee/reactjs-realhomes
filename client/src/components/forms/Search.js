  ...
  return (
    <form action="" className="relative">
      <div className="flex">
        ...
        />
        <button className="px-4 py-3 text-gray-200 transition duration-500 ease-in-out bg-gray-800 border border-l-0 border-gray-800 rounded rounded-l-none hover:bg-yellow-600 hover:border-yellow-600">
