  ...
  return (
    <footer className="w-screen">
      ...
      >
        ...
        <div className="relative flex flex-wrap px-8 lg:px-12">
          {/* LOGO */}
          <div className="flex flex-col sm:w-1/2 sm:px-4 sm:pb-12">
            ...
            <p className="mt-2 font-hairline leading-6 tracking-wider text-teal-200 sm:text-sm">
              ...
              officia aperiam? Aut, neque sequi?
            </p>
          ...
          <div className="pt-8 sm:pt-0 sm:w-1/2 sm:px-4 sm:pb-12">
            ...
            <form class="w-full max-w-sm mt-6">
              <div class="flex items-center border-b border-b-2 border-teal-500 py-2">
                <input
                  className="w-full px-2 py-1 mr-3 text-lg text-gray-300 bg-transparent border-none appearance-none focus:outline-none"
                  type="text"
